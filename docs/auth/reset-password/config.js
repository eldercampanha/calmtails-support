(function () {
  ...
  var isDevPath =
    path.indexOf("/calmtails-support/dev/") === 0 ||
    path.indexOf("/dev/") === 0;
...
var productionConfig = {
  ...
  supabaseAnonKey:
    "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imd0YWN3ZmFwd3hmcmxkYXhsaGNoIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjU3Njc2MDksImV4cCI6MjA4MTM0MzYwOX0.kkvMHqB7gBDR66eHZ8XpgXoYmCcrrSqKOQ9uLeOXhDE",
  supabasePublishableKey:
    "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imd0YWN3ZmFwd3hmcmxkYXhsaGNoIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjU3Njc2MDksImV4cCI6MjA4MTM0MzYwOX0.kkvMHqB7gBDR66eHZ8XpgXoYmCcrrSqKOQ9uLeOXhDE",
};
  ...
  window.CALMTAILS_RESET_CONFIG = Object.assign(
    {},
    sharedConfig,
    isDevPath ? devConfig : productionConfig
  );
})();
